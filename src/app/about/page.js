...
import aboutImage1 from '../../img/aboutus/manholdingpeas.jpg'
import aboutImage2 from '../../img/aboutus/foodrack.jpg'
import aboutImage3 from '../../img/aboutus/veggies4.jpg'
...
export default function AboutUs() {
  ...
  return (
      ...
      <div className="about-img-wrap">
        <Image className="about-img" src={aboutImage1} alt="" />
      </div>
      ...
      <div className="about-img-wrap">
        <Image className="about-img" src={aboutImage2} alt="" />
      </div>
      ...
      <div className="about-img-wrap">
        <Image className="about-img" src={aboutImage3} alt="" />
      </div>
