      ...
      <main className="homepage" id="page-wrap">
        <Parallax bgImage={grapefruit1} strength={300}>
          <div className="homepage__callout" ref="box1"> 
            ...
            <p>
            	<NavLink to="/work/freshgrocer/findstores" className="btn" activeClassName="active">Find a store near you</NavLink>
            </p>
          </div>
        </Parallax>
        ...
        <Parallax bgImage={pumpkins2} strength={300}>
          <div className="homepage__callout" ref="box2"> 
            ...
            <p>
            	<NavLink to="/work/freshgrocer/onsale" className="btn" activeClassName="active">Check out the latest deals</NavLink>
            </p>
          </div>
        </Parallax>
        ...
        <Parallax bgImage={personholdingsb2} strength={300}>
          <div className="homepage__callout" ref="box3"> 
            ...
            <p>
            	<NavLink to="/work/freshgrocer/about" className="btn" activeClassName="active">Read about our history</NavLink>
            </p>
          </div>
        </Parallax>
        ...
        <Parallax bgImage={cuttingboard} strength={300}>
          <div className="homepage__callout" ref="box4"> 
            ...
            <p>
            	<NavLink to="/work/freshgrocer/recipes" className="btn" activeClassName="active">Find a great recipe</NavLink>
            </p>
          </div>
        </Parallax>
