...
import { 
	mainHeaderImgConfig,
	innerpTitleConfig,
  aboutImgConfig } from './sr/srConfig'
...
class AboutUs extends Component {
  ...
  componentDidMount() {
    ...
    sr.reveal(this.aboutImg1, aboutImgConfig);
    sr.reveal(this.aboutImg2, aboutImgConfig);
    sr.reveal(this.aboutImg3, aboutImgConfig);
  }


  render() {
    const aboutImage1 = {
      backgroundImage: `url(${manholdingpeas})`
    }
    const aboutImage2 = {
      backgroundImage: `url(${foodrack})`
    }
    const aboutImage3 = {
    ...
    return (
        ...
        <div className="innerpage__largeBgImg" style={aboutImage1} ref={(r) => { this.aboutImg1 = r; }} />
        ...
        <div className="innerpage__largeBgImg" style={aboutImage2} ref={(r) => { this.aboutImg2 = r; }} />
        ...
        <div className="innerpage__largeBgImg" style={aboutImage3} ref={(r) => { this.aboutImg3 = r; }} />
